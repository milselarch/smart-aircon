    ...
    [
      ...
      _c(
        ...
        [
          ...
          _c("TextField", {
            staticClass: "message",
            attrs: { col: "0", row: "1", text: _vm.inputTemp },
            on: {
              textChange: function($event) {
                _vm.inputTemp = $event.value
              }
            }
          }),
          _c("Label", {
            staticClass: "message",
            attrs: { text: _vm.inputTemp, col: "0", row: "2" }
          }),
          _c("Button", { attrs: { text: "Button" }, on: { tap: _vm.add } })
        ],
        1
      )
    ],
...
module.exports = {"android":{"v8Flags":"--expose_gc"},"main":"main","name":"smart_aircon","version":"1.0.0"};
